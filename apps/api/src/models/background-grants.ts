...
export class BackgroundGrant {
	...
	@OneToMany(() => Skill, (skill) => skill.grant, {
		nullable: true,
		onDelete: "SET NULL",
	})
	skills!: Skill[] | null; // if the grant is a skill proficiency, which skill is granted

	@OneToMany(() => Language, (language) => language.grant, {
		nullable: true,
		onDelete: "SET NULL",
	})
	languages!: Language[] | null; // if the grant is a language proficiency, which language is granted
	...
	@OneToMany(() => Feat, (feat) => feat.grant, {
		nullable: true,
		onDelete: "SET NULL",
	})
	feats!: Feat[] | null; // if the grant is a feat, which feat is granted
}
